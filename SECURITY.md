...
1. **GitHub Security Advisory:** Submit a private report via the [Security Advisories](https://github.com/omid-io/vibe-ui-skills/security/advisories) tab.
2. **Direct Email:** Contact the maintainer at `3ntimental@gmail.com` with the subject `[SECURITY] Vibe UI Skills Vulnerability Report`.
