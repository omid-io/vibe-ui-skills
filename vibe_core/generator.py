"""
vibe_core.generator — Autonomous Component & Interface Generator
Generates production-grade, responsive, accessible HTML/Tailwind interfaces from DesignDecisionContract.
"""
...
class InterfaceGenerator:
    ...
    def generate_html(self, decision: Dict[str, Any], prompt_title: str = "Vibe UI Component") -> str:
        ...
        font_url = "https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&family=Playfair+Display:ital,wght@0,600;1,400&family=Vazirmatn:wght@400;500;600;700&family=JetBrains+Mono:wght@400;500&display=swap"
