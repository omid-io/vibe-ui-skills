...
function activate(context) {
    ...
    context.subscriptions.push(vscode.window.registerWebviewViewProvider('vibe-ui.chemistryExplorer', provider));
    // 2. Register Audit Command
    context.subscriptions.push(vscode.commands.registerCommand('vibe-ui.auditContrast', () => {
    ...
    context.subscriptions.push(vscode.commands.registerCommand('vibe-ui.insertAdapter', async () => {
...
function deactivate() { }
class ChemistrySidebarProvider {
    _extensionUri;
